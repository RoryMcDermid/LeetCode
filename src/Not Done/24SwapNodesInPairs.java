...
class Solution {
    public ListNode swapPairs(ListNode head) {
        ...
        while (current != null) {
            ...
            // is it because head isn't being altered properly?
            // -------------is breaking, a print here shows that it has the correct values
            // in current and current.next, just isn't saving them right
